...
<div class="index2dingbu">
    ...
    <table id="表单" style="width: 1150px">
        ...
        <tr style="width: 20%">
            <td>班级：</td>
            <td><input id="班级"  name="sclass" list="wlmslist" class="frominput" type="text" />
                <datalist id="wlmslist">
                    <option value="17中软一"></option>
                    <option value="18软件一"></option>
                    <option value="17环艺一"></option>
                    <option value="18电竞一"></option>
                </datalist></td>
        </tr>
        <tr style="width: 10%">
            <td>
                <button id="添加2"><input style="background-color: rgba(0,0,0,0); border: 0px; margin-right: 5px; padding: 0; font-size: 16px; color: #FFFFFF" type="submit" value="班级查询"></button>
            </td>
        </tr>
        </form>
        <tr>
            ...
            <td>
                <button id="添加3"><input style="background-color: rgba(0,0,0,0); border: 0px; margin-right: 5px; padding: 0; font-size: 16px; color: #FFFFFF" type="submit" value="点击添加"></button>
            </td>
            </form>
        </tr>
    </table>
